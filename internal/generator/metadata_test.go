...
func TestQuestionMetadataForKnowledgePoint(t *testing.T) {
	tests := []struct {
		...
		{name: "clinical digestive", kp: domain.KnowledgePoint{Category: "临床综合", Subject: "三、消化系统"}, requested: "三、消化系统", profession: "消化", system: "三、消化系统"},
		{name: "clinical orthopedics", kp: domain.KnowledgePoint{Category: "临床综合", Subject: "九、运动系统"}, profession: "骨科", system: "九、运动系统"},
		{name: "explicit profession", kp: domain.KnowledgePoint{Category: "临床综合", Subject: "三、消化系统"}, requested: "消化内科", profession: "消化内科", system: "三、消化系统"},
