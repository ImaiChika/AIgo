...
3. 正文禁止出现任何“字段名加冒号”的分段标签；主诉、病史、体格信息、检查信息和最后提问必须自然衔接，不能写成模板标签。
...
2. cognitive_level 只能是“记忆、理解、简单应用、综合应用”之一。
